import sys
import os
# In a virtual environment, you may need this line to properly include this module
sys.path.append(os.path.dirname(__file__))

from main import make_plot, make_plot_masked
...
from config import MASKED, CHANNEL_TO_LISTEN_TO

# TTS READER SCRIPT modified by onura46 (Kaelin Bougneit)
...
MAX_WORKERS = 1000000 # Maximum number of threads you can process at a time 
...
class ChatReader:
    ...
    def handle_message(message):
        try:
            ...
            ####################################
            ####################################
            with open("save/chatlog.txt", "a+") as MSG_QUEUE:
                msg = msg.lower()
                MSG_QUEUE.write(f"{msg}\n")
